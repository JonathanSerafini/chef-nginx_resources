...
default['nginx_resources']['source']['include_recipes'].tap do |config|
  config['nginx_resources::module_ndk'] = true
  config['nginx_resources::module_ssl'] = true
  config['nginx_resources::module_realip'] = true
  config['nginx_resources::module_stub_status'] = true
  config['nginx_resources::module_fastcgi'] = true
  config['nginx_resources::module_gzip'] = true
end
